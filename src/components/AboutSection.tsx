        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.p
              ...
              style={{ fontFamily: "'Montserrat', sans-serif" }}
            >
              I'm <span className="text-[#F3DBB3] font-medium">Krisha Pore</span>, a Computer Science &amp; Technology undergraduate at LJ University specializing in full-stack architecture, AI-powered systems, and modern web applications. Proficient in Python, Django, React, and Java with strong foundations in data structures and real-world problem solving, I design and build resilient, scalable digital solutions.
            </motion.p>
            ...
            >
              ...
              <div className="flex flex-col">
                <span 
                  className="text-3xl sm:text-4xl font-normal text-[#F4EBE2] stat-value-white tracking-tight"
                  style={{ fontFamily: "'Bebas Neue', sans-serif" }}
                >
                  20+
                </span>
                <span className="text-[10px] font-semibold tracking-[0.22em] uppercase text-[#A8988B] stat-label mt-0.5">
                  REST APIs Built
                </span>
              </div>
              ...
              <div className="flex flex-col">
                <span 
                  className="text-3xl sm:text-4xl font-normal text-[#D4AF37] stat-value-gold tracking-tight"
                  style={{ fontFamily: "'Bebas Neue', sans-serif" }}
                >
                  &lt; 3.5s
                </span>
            ...
            >
              ...
              <div className="relative overflow-hidden w-full max-w-[390px] aspect-[4/5] bg-black rounded-sm">
                ...
                <img
                  src={aboutImg}
                  alt="Krisha Pore"
                  className="w-full h-full object-cover object-top filter brightness-[1.04] contrast-[1.04] saturate-[1.02] group-hover:brightness-[1.08] group-hover:contrast-[1.08] transition-all duration-700 ease-out"
                />
