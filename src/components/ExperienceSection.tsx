...
const journey: RouteStop[] = [
  {
    ...
    title: 'AI PLATFORM ARCHITECT & DEV',
    organization: 'NEXORA — DEVELOPER CAREER PLATFORM',
    description: 'Engineered AI Code Review Engine using Groq LLaMA 3 with thread-safe GitHub Token Pool, 20+ optimized REST endpoints, and 95+ Lighthouse React frontend.',
  },
  {
    id: '02',
    year: 'FEB 2026',
    title: 'FULL STACK & REAL-TIME DEV',
    organization: 'STUDYVERSE — PRODUCTIVITY PLATFORM',
    description: 'Built collaborative platform with Python Flask, Google Generative AI multimodal pipelines, 15+ PostgreSQL/Neon tables, and WebSockets live synchronization.',
  },
  {
    id: '03',
    year: 'JAN 2026',
    title: 'FULL STACK DEVELOPER',
    organization: 'SKILLBRIDGE — FREELANCING PLATFORM',
    description: 'Developed full-stack marketplace with Python, Flask, and PostgreSQL featuring role-based workflows and structured RESTful APIs.',
  },
  {
    id: '04',
    ...
    description: 'Focused on advanced software development, scalable system architectures, Data Structures & Algorithms, and modern web frameworks.',
  },
  {
    id: '05',
    year: '2024 – 2026',
    ...
    description: 'Certified across Java Core (2024), Data Structures in Java (2025), Web Development (HTML/CSS/JS 2025), and Exploratory Data Analysis for ML (2026).',
  },
];
