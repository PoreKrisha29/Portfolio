...
const bentoCategories = [
  {
    ...
    badge: 'UI / UX SYSTEMS',
    items: ['React.js', 'JavaScript', 'Tailwind CSS', 'HTML5 & CSS3', 'Vite', 'Recharts'],
    description: 'Specialized in building high-performance client applications, data dashboards, responsive component libraries, and optimized interfaces.',
    stat: '95+ LIGHTHOUSE',
  ...
  },
  {
    ...
    items: ['Python', 'Django', 'Flask', 'Node.js', 'Express.js', 'REST APIs', 'JWT'],
    description: 'Engineered thread-safe token pooling, rate-limit failovers, OAuth 2.0 auth, and micro-latency RESTful endpoints.',
    stat: '< 80ms LATENCY',
  ...
  },
  {
    ...
    badge: 'PERSISTENCE',
    items: ['PostgreSQL', 'Neon DB', 'MongoDB', 'psycopg2', 'Schema Design'],
    description: 'Designing normalized relational schemas (15+ tables), select_related query optimization, and automated migration scripts.',
    stat: 'ACID & NOSQL',
    colSpan: 'lg:col-span-5',
  },
  {
    title: 'AI INTEGRATION & CORE ENGINEERING',
    badge: 'INTELLIGENCE & FOUNDATIONS',
    items: ['Groq LLaMA 3', 'Gemini AI', 'Data Structures & Algorithms', 'Java', 'OOP', 'WebSockets'],
    description: 'Built multi-worker AI review engines scanning 18+ languages in <3.5s, multimodal document parsers, and real-time Socket.IO sync.',
    stat: '18+ LANGS SCAN',
    colSpan: 'lg:col-span-7',
  },
];
          ...
          {bentoCategories.map((block, idx) => (
            ...
            >
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-[10px] font-mono px-2.5 py-0.5 border border-[#8C6D4F]/40 text-[#C4B5A5] bg-[#17130F] group-hover:border-[#D4AF37]/50 group-hover:text-white transition-all bento-stat">
                  {block.stat}
                </span>
              </div>
